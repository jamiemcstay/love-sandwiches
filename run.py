...
def calculate_surplus_data(sales_row):
    ...
    - Negative surplus indicates extrea made when stock was sold out. 
    """
...
def get_last_5_entries():
    """
    Collects columnns of data from sales worksheet, collecting
...
def calculate_stock_data(data):
    """
    Calculate the average stick for each item type, adding 10%.
    """
